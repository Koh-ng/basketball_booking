...
const RULES = [
  ...
  "Voting sẽ khoá vào 12h trưa thứ 5 trước buổi chơi; nếu vote đi mà không đi thì vẫn sẽ tính và đóng tiền. Nếu có thể tham gia được hoặc đổi ý sau đó, vui lòng nhắn lên group",
